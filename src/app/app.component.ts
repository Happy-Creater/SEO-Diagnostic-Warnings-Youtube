...
export class AppComponent implements OnInit {
  ...
  showCustomPreviousYear() {
    $('#tdRadioDatepicker5').hide();
    $('#tdRadioDatepickerPreviousYear').show();
  }

  hideCustomPreviousYear() {
    $('#tdRadioDatepicker5').show();
    $('#tdRadioDatepickerPreviousYear').hide();
  }

  forceActivePreviousScan() {
    if (!$('#labelDatepicker2').hasClass('active')) {
      $('#labelDatepicker2').addClass('active');
      $('#radioDatepicker2').prop('checked', true);
    }
  }
  ...
  saveSelectedDateCompare(selected, dStart, dEnd) {
    ...
    try {
      dateCalendarStart = $('.calendar_daterangepicker_start').val().split('-');
    } catch (e) {
    }
    ...
    let dateCalendarEnd = [];
    try {
      dateCalendarEnd = $('.calendar_daterangepicker_end').val().split('-');
    } catch (e) {
    }

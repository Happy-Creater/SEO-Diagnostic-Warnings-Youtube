...
const routes = [
  {
    ...
    children: [
      ...
      {
        path: 'diagnostic-warnings',
        loadChildren: './seo-diagnostic-warnings/seo-diagnostic-warnings.module#SeoDiagnosticWarningsModule',
      },
      ...
      {
        path: 'offsite-opt-blog-automation',
        loadChildren: './seo-offsite/seo-offsite-optimization/seo-offsite-opt-blog-automation/seo-offsite-opt-blog-automation.module#SeoOffsiteOptBlogAutomationModule'
      },
